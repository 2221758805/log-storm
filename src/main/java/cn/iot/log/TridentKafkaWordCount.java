...
public class TridentKafkaWordCount {
    ...
    private String zkBrokerPath;
    private String brokerUrl;

    TridentKafkaWordCount(String zkUrl,String zkBrokerPath,String brokerUrl) {
        this.zkUrl = zkUrl;
    ...
    private TransactionalTridentKafkaSpout createKafkaSpout() {
        ZkHosts hosts = new ZkHosts(zkUrl,zkBrokerPath);
        TridentKafkaConfig config = new TridentKafkaConfig(hosts, "apiserver_log_dev");
    ...
    public static void main(String[] args) throws Exception {
        ...
        String zkUrl = "192.168.156.60:2181";        // the defaults.
        String zkBrokerPath = "/kafka/brokers"; 
        String brokerUrl = "192.168.156.60:9092";
...
//        }
        ...
        TridentKafkaWordCount wordCount = new TridentKafkaWordCount(zkUrl,zkBrokerPath,brokerUrl);
...
//            for (int i = 0; i < 60; i++) {
//                System.out.println("DRPC RESULT: " + drpc.execute("words", "appid ebid"));
//                Thread.sleep(1000);
//            }
